  ...
  return (
    <div className="border border-gray-200 bg-white rounded-2xl">
      <div className="p-8">
        <div className="flex justify-center">
          <div className="border border-gray-300 rounded-[10px] flex justify-center items-center mb-6 p-1 w-max">
            <div className="flex flex-row items-center border border-gray-300 rounded-[10px] gap-1.5 p-2">
      ...
      <div className="flex justify-center p-8">
        <button className="w-full bg-secondary rounded-md text-white text-md font-semibold py-3">
          Get started
        </button>
      </div>
    </div>
